          ...
          {site.progetti.items.map((p, i) => (
            <Reveal key={p.slug} delay={i * 90}>
              <Link
                ...
                className="group relative flex h-full flex-col overflow-hidden rounded-[1.75rem] bg-surface p-8 ring-1 ring-brand/12 transition-transform duration-300 hover:-translate-y-1.5"
              >
                <span
                  aria-hidden="true"
